...
show_search_button.setFixedSize(100,55)
...
show_add_button_window.setFixedSize(100,55)
...
show_borrow_window.setFixedSize(100,55)
...
show_return_window.setFixedSize(100,55)
...
show_edit_window.setFixedSize(100,55)
...
sort_method_box_options.setFixedSize(115,30)
...
class SEARCH_BOOK:
    def __init__(self):
        search_window.setFixedSize(450,150) 
        search_window.show()
...
QTableWidget{
    background:white;
        ...
        search_input_parmeter.setFixedSize(150,30)
        ...
        search_input_name.setFixedSize(150,30)
    ...
    def find_book(self):
        ...
        show_result_table_of_search.setFixedSize(500,300)
        show_result_table_of_search.show()
        search_result_table.setFixedSize(500,300)
...
class ADD_BOOK:
    def __init__(self):
        add_book_window.setFixedSize(520,400)
...
QTableWidget{
    background:white;
        ...
        #TITLE ADDED
        add_book_title_input.setFixedSize(150,30)
        ...
        #CATEGORY ADDED
        add_book_category_input.setFixedSize(150,30)
        ...
        add_book_classification_input.setFixedSize(150,30)
        ...
        #AUTHOR ADDED
        add_book_author_input.setFixedSize(150,30)
        ...
        #available_copies
        add_book_available_copies_input.setFixedSize(150,30)
        ...
        #PUBLICATION INFORMATION
        add_book_publication_input.setFixedSize(150,30)
        ...
        #PAGES ADDED
        add_book_pages_input.setFixedSize(150,30)
        ...
        #**************************************************
        #TRANSLETOR ADDED
        add_book_transletor_input.setFixedSize(150,30)
        ...
        #SHELF ADDED
        add_book_shelf_input.setFixedSize(150,30)
        ...
        #ROW ADDED
        add_book_row_input.setFixedSize(150,30)
        ...
        #BINDING ADDED
        add_book_binding_input.setFixedSize(150,30)
        ...
        #UNIT PRICE ADDED
        add_book_unit_price_input.setFixedSize(150,30)
        ...
        #TOTAL PRICE
        add_book_total_price_input.setFixedSize(150,30)
        ...
        add_book_year_input.setFixedSize(150,30)
        ...
        #********************************************************
        #ISBN ADDED
        add_book_ISBN_input.setFixedSize(150,30)
        ...
        #VOLUMES ADDED
        add_book_volumes_input.setFixedSize(150,30)
        ...
        #VOLUME ADDED   
        add_book_volume_input.setFixedSize(150,30)
        ...
        #total_copies
        add_book_total_copies_input.setFixedSize(150,30)
        ...
        #LANGUAGE ADDED
        add_book_language_input.setFixedSize(150,30)
        ...
        #NOTES
        add_book_notes_input.setFixedSize(150,30)
...
class DELETE_BOOK:
    def __init__(self):
        delete_window.setFixedSize(200,100)
        delete_window.show()
...
QTableWidget{
    background:white;
        ...
        delete_book_input.setFixedSize(100,30)
...
class BORROW_BOOK:
    def __init__(self):
        borrow_window.setFixedSize(250,130)
        borrow_window.show()
...
QTableWidget{
    background:white;
        ...
        borrow_title_input.setFixedSize(100,30)
        ...
        guaranty_button.setFixedSize(100,30)
    ...
    def status_of_book(self):
        ...
        if status_of_wanted_book==0:
            guarantyOption.setFixedSize(260,80)
            guarantyOption.show()
            passport_button.setText("Passport")
            passport_button.setFixedSize(100,40)
            passport_button.move(20,20)
            identityCard_button.setText("Identity Card")
            identityCard_button.setFixedSize(100,40)
    ...
    def Passport(self):
        passport_window.setFixedSize(360,300)
        passport_window.show()
        passport_Id_input.setFixedSize(100,30)
        passport_Id_input.move(20,30)
        passport_Id_input.returnPressed.connect(passport_name_input.setFocus)
        passport_Id_label.setText("Passport_No")
        passport_Id_label.move(20,10)
        passport_Id_label.show()

        passport_name_input.setFixedSize(100,30)
        passport_name_input.move(20,90)
        passport_name_input.returnPressed.connect(passport_nationality_input.setFocus)
        passport_name_label.setText("Name")
        passport_name_label.move(20,70)
        passport_name_label.show()

        passport_nationality_input.setFixedSize(100,30)
        passport_nationality_input.move(20,150)
        passport_nationality_input.returnPressed.connect(passport_date_of_birth_input.setFocus)
        passport_nationality_label.setText("Nationality")
        passport_nationality_label.move(20,130)
        passport_nationality_label.show()

#**********************************************************************
        passport_date_of_birth_input.setFixedSize(100,30)
        passport_date_of_birth_input.move(130,30)
        passport_date_of_birth_input.returnPressed.connect(passport_place_of_birth_input.setFocus)
        ...
        passport_place_of_birth_input.setFixedSize(100,30)
        passport_place_of_birth_input.move(130,90)
        passport_place_of_birth_input.returnPressed.connect(passport_date_of_issue_input.setFocus)
        ...
        passport_date_of_issue_input.setFixedSize(100,30)
        passport_date_of_issue_input.move(130,150)
        passport_date_of_issue_input.returnPressed.connect(passport_book_input.setFocus)
        ...
        passport_book_input.setFixedSize(100,30)
        passport_book_input.move(130,210)
        passport_book_input.returnPressed.connect(passport_date_of_receive_input.setFocus)
        passport_book_label.setText("Name Of Book")
        passport_book_label.move(130,190)
        passport_book_label.show()
#****************************************************************

        passport_date_of_receive_input.setFixedSize(100,30)
        passport_date_of_receive_input.move(240,30)
        passport_date_of_receive_input.returnPressed.connect(passport_date_of_return_input.setFocus)
        ...
        passport_date_of_return_input.setFixedSize(100,30)
        passport_date_of_return_input.move(240,90)
        passport_date_of_return_input.returnPressed.connect(passport_date_of_expiry_input.setFocus)
        ...
        passport_date_of_expiry_input.setFixedSize(100,30)
        passport_date_of_expiry_input.move(240,150)
        passport_date_of_expiry_input.returnPressed.connect(passport_confirmation_key.setFocus)
        ...
        passport_confirmation_key.setFixedSize(330,30)
    ...
    def identiyCard(self):
        identityCard_window.setFixedSize(400,320)
        identityCard_window.show()

        identitycard_id_input.setFixedSize(100,30)
        identitycard_id_input.move(20,30)
        identitycard_id_input.returnPressed.connect(identitycard_name_input.setFocus)
        identitycard_id_label.setText("ID_Number")
        identitycard_id_label.move(20,10)
        identitycard_id_label.show()

        identitycard_name_input.setFixedSize(100,30)
        identitycard_name_input.move(20,90)
        identitycard_name_input.returnPressed.connect(identitycard_nationality_input.setFocus)
        identitycard_name_label.setText("Full Name")
        identitycard_name_label.move(20,70)
        identitycard_name_label.show()

        identitycard_nationality_input.setFixedSize(100,30)
        identitycard_nationality_input.move(20,150)
        identitycard_nationality_input.returnPressed.connect(identitycard_gender_input.setFocus)
        ...
        identitycard_gender_input.setFixedSize(100,30)
        identitycard_gender_input.move(20,210)
        identitycard_gender_input.returnPressed.connect(identitycard_date_of_birth_input.setFocus)
        identitycard_gender_label.setText("Gender")
        identitycard_gender_label.move(20,190)
        identitycard_gender_label.show()
        #**************************************************
        
        identitycard_date_of_birth_input.setFixedSize(100,30)
        identitycard_date_of_birth_input.move(130,30)
        identitycard_date_of_birth_input.returnPressed.connect(identitycard_place_of_birth_input.setFocus)
        ...
        identitycard_place_of_birth_input.setFixedSize(100,30)
        identitycard_place_of_birth_input.move(130,90)
        identitycard_place_of_birth_input.returnPressed.connect(identitycard_date_of_issue_input.setFocus)
        ...
        identitycard_date_of_issue_input.setFixedSize(100,30)
        identitycard_date_of_issue_input.move(130,150)
        identitycard_date_of_issue_input.returnPressed.connect(identitycard_date_of_expiry_input.setFocus)
        ...
        identitycard_date_of_expiry_input.setFixedSize(100,30)
        identitycard_date_of_expiry_input.move(130,210)
        identitycard_date_of_expiry_input.returnPressed.connect(identitycard_date_of_receive_input.setFocus)
        ...
        identitycard_date_of_receive_input.setFixedSize(100,30)
        identitycard_date_of_receive_input.move(240,30)
        identitycard_date_of_receive_input.returnPressed.connect(identitycard_date_of_return_input.setFocus)
        ...
        identitycard_date_of_return_input.setFixedSize(100,30)
        identitycard_date_of_return_input.move(240,90)
        identitycard_date_of_return_input.returnPressed.connect(identitycard_book_input.setFocus)
        ...
        identitycard_book_input.setFixedSize(100,30)
        identitycard_book_input.move(240,150)
        identitycard_book_input.returnPressed.connect(identitycard_conformiton_key.setFocus)
        identitycard_book_label.setText("Book")
        identitycard_book_label.move(240,130)
        identitycard_book_label.show()

        identitycard_conformiton_key.setFixedSize(340,30)
...
class RETURN_BOOK:
    def receive_book(self):
        return_window.setFixedSize(340,160)
        return_window.show()
...
QTableWidget{
    background:white;
        ...
        return_parameter_input.setFixedSize(100,30)
        ...
        return_id_input.setFixedSize(100,30)
...
class EDIT_BOOK:
    def edit_book(self):
        edit_window.setFixedSize(260,190)
        edit_window.show()
...
QTableWidget{
    background:white;
        ...
        edit_name_of_book_input.setFixedSize(100,30)
        ...
        edit_parameter_input.setFixedSize(100,30)
...
class SORTED_BOOK:
    def sort_book(self):
        sort_window.setFixedSize(270,130)
        sort_window.show()
...
QTableWidget{
    background:white;
        ...
        sort_sorted_parameter_input.setFixedSize(100,30)
        ...
        sort_method_input.setFixedSize(100,30)
    ...
    def implement_sort(self):
        ...
        sorted_table_window.setFixedSize(1000,500)
        sorted_table_window.show()
        sorted_table.setFixedSize(1000,500)
...
class PATRON:
    def patron(self):
        patron_window.setFixedSize(250,260)
        patron_window.show()
...
#**********************************************
        ...
        patron_semester_input.setFixedSize(100,30)
        ...
        patron_major_input.setFixedSize(100,30)
        ...
        patron_confirmation_button.setFixedSize(210,30)
...
class CURRENT_PATRON:
    def currentPatron(self):
        current_patron_window.setFixedSize(740,300)
...
QTableWidget{
    ...
    def receive_book(self):
        current_patron_receive_book_window.setFixedSize(250,110)
        current_patron_receive_book_window.show()
        current_patron_name_input.setFixedSize(100,30)
        ...
        current_patron_book_input.setFixedSize(100,30)
        ...
        current_patron_confirmation_button.setFixedSize(100,30)
...
class REPORT: 
    def show_options(self):
        report_window.setFixedSize(200,220)
        report_window.show()
        report_book.setText("Book")
        report_book.setFixedSize(100,30)
...
QTableWidget{
    background:white;
        ...
        report_potrons.setFixedSize(100,30)
        report_potrons.move(50,110)

        report_deleted_book.setText("Deleted Book")
        report_deleted_book.setFixedSize(100,30)
